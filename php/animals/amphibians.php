...
<div class="container mt-5">
    ...
    <div class="text-center mt-1 my-3">
        <a href="/TermProject1/php/lists/listamphibians.php" class="btn btn-lg btn-success text-white">See the List of Amphibians in Our Zoo</a>
    </div>

    <!-- Hero Section with Image -->
    <div class="row justify-content-center">
        <div class="col-md-8 text-center">
            <img src="/TermProject1/pictures/amphibians.jpeg" alt="Amphibians" class="img-fluid rounded-5 shadow-lg border text-success">
        </div>
    </div>
    ...
    <div class="row my-5">
        ...
        <div class="col-md-6 text-center p-3">
            <img src="/TermProject1/pictures/amphibianschar.png" alt="Amphibian Characteristics" height="200" width="300" class="rounded-5 shadow-lg text-success">
        </div>
    </div>
